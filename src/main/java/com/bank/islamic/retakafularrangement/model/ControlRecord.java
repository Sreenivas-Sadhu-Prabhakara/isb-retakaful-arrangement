package com.bank.islamic.retakafularrangement.model;
...
/**
 * The BIAN control record for this service domain: "Retakaful Treaty Management Plan".
 *
 ...
 * to its asset type (Retakaful Treaty). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Retakaful Treaty Management Plan";
